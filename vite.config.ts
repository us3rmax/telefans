...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      // TanStack Start's browser client imports node:async_hooks even though
      // AsyncLocalStorage is a Node-only API. Point both specifiers at the
      // browser-safe shim so the preview does not instantiate Vite's empty
      // externalized module.
