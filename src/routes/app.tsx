 ...
 * throwing browser stub) and ships a BLANK preview ("AsyncLocalStorage is not a constructor").
 */
...
function AppLayout() {
  ...
  if (checking || !authorized) {
    return <main className="flex min-h-dvh items-center justify-center bg-background text-sm text-muted-foreground">A validar acesso…</main>
  }
