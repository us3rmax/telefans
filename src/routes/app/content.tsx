...
function AdminContentPage() {
  ...
  const load = async () => {
    ...
    try {
      const [nextPosts, nextCreators] = await Promise.all([listAdminPosts(status === 'all' ? undefined : { status }), listAdminCreators()])
  ...
  }, [posts, creators, creatorId, query])
