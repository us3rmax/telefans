...
function DashboardHome() {
  ...
  const handleFiles = async (creator: Creator, files: File[]) => {
    ...
    try {
      ...
      if (!Number.isFinite(price) || price < 0) throw new Error('Defina um preço válido para Paid Media.')
